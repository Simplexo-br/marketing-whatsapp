...
with registry.cursor() as cr:
    ...
    for t in Template.search([]):
        print(f"--- Template: {t.name} (ID: {t.id}) | Categoria: {t.category} | Status: {t.status} ---")
        print("Body:", t.body_text)
        print("Header:", t.header_text, "Type:", t.header_type)
        print("Variables count:", t.variables_count)
"""
