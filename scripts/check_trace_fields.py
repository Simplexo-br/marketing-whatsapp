...
with registry.cursor() as cr:
    ...
    trace_sample = Trace.search([('trace_type', '=', 'whatsapp')], limit=1)
    if trace_sample:
        print("Mailing trace sample:")
        print("  model:", trace_sample.model)
        print("  res_id:", trace_sample.res_id)
        print("  fields related to contact:", [f for f in Trace._fields if 'contact' in f or 'partner' in f or 'res' in f])
"""
