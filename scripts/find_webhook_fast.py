...
print("=== BUSCANDO EM /opt/odoo/addons ===")
res = subprocess.run("grep -rn 'webhook' /opt/odoo/addons/simplexo* 2>/dev/null", shell=True, capture_output=True, text=True)
print(res.stdout[:2000])

print("=== LISTANDO PASTAS EM /opt/odoo/addons ===")
res2 = subprocess.run("ls -d /opt/odoo/addons/*whatsapp* /opt/odoo/addons/*aios*", shell=True, capture_output=True, text=True)
print(res2.stdout)
"""
