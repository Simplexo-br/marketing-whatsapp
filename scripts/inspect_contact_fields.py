...
with registry.cursor() as cr:
    ...
    phone_fields = [f for f in Contact._fields if 'phone' in f or 'mobile' in f or 'number' in f or 'country' in f]
    print("Campos relacionados a telefone em mailing.contact:", phone_fields)
    print("Todos os campos de mailing.contact:", list(Contact._fields.keys()))
"""
