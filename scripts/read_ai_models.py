...
with open('/opt/odoo/addons/simplexo_aios_whatsapp_ai/models/whatsapp_message.py', 'r') as f:
    print("=== simplexo_aios_whatsapp_ai/models/whatsapp_message.py ===")
    print(f.read())

with open('/opt/odoo/addons/simplexo_ai_assistant_aios/models/aios_bridge.py', 'r') as f:
    print("\\n=== simplexo_ai_assistant_aios/models/aios_bridge.py ===")
    print(f.read())
"""
