...
with registry.cursor() as cr:
    ...
    print("Total IDs:", len(res_ids))
    target_model = m.mailing_model_real
    records = env[target_model].browse(res_ids)
    print("Total browse records:", len(records))
    first = records[0]
    print(f"First: ID={first.id}, Name={first.name}, Mobile={first.mobile}, MobileWA={first.mobile_whatsapp}")
"""
