...
print("=== CONTROLLERS EM simplexo_aios_whatsapp_api ===")
res = subprocess.run("grep -rn 'webhook' /opt/odoo/addons/simplexo_aios_whatsapp* 2>/dev/null", shell=True, capture_output=True, text=True)
