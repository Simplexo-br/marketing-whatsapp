...
cmd = "diff -u /opt/odoo/addons/simplexo_aios_whatsapp/models/whatsapp_message.py.bak_webhook /opt/odoo/addons/simplexo_aios_whatsapp/models/whatsapp_message.py | head -n 100"
p = subprocess.run(cmd, shell=True, stdout=subprocess.PIPE, text=True)
print("Diferenças entre bak_webhook e atual em whatsapp_message.py:")
print(p.stdout[:3000])
"""
