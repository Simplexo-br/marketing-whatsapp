...
with registry.cursor() as cr:
    ...
    wa_traces = Trace.search([('trace_type', '=', 'whatsapp')])
    print(f"Total de mailing.trace do tipo whatsapp: {len(wa_traces)}")
    all_trace_types = set(Trace.search([]).mapped('trace_type'))
    print("Tipos de trace existentes no banco:", all_trace_types)
"""
