...
cmd = "find /opt/odoo/addons/marketing_whatsapp -type f -mtime -2 -exec ls -lt {} +"
res = subprocess.run(cmd, shell=True, stdout=subprocess.PIPE, text=True)
print("Arquivos modificados nos últimos 2 dias em /opt/odoo/addons/marketing_whatsapp:")
print(res.stdout)
"""
